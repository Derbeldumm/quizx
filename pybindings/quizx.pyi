...
class Decomposer:
    ...
    def __init__(
        ...
        *,
        ...
        simp: Optional[SimpFunc] = None,
    ) -> None: ...
    def done(self) -> List[VecGraph]: ...
    def with_simp(self, simp: SimpFunc) -> None: ...
    def with_full_simp(self) -> None: ...
    def with_clifford_simp(self) -> None: ...
    def with_split_graph_components(self, b: bool) -> None: ...
    def with_save(self, b: bool) -> None: ...
    def max_terms(self) -> int: ...
    def decompose(
        self,
        driver_type: str = "BssWithCats",
        random_t: bool = False,
        sherlock_tries=[],
    ) -> None: ...
...
def apply_single_decomp(g: VecGraph, verts: List[VecGraph]) -> List[VecGraph]: ...
def apply_magic5_decomp(g: VecGraph, verts: List[VecGraph]) -> List[VecGraph]: ...

def eff_alpha(g: VecGraph, decomp_type: str, verts: List[VecGraph]) -> np.float64: ...

def generate_iqp_circuit_graph(qubits: int) -> VecGraph: ...
def generate_mod_shift_circuit_graph(qubits: int, n_fredkin: int) -> VecGraph: ...
def generate_exp_pauli_circuit_graph(qubits: int, depth: int) -> VecGraph: ...
def generate_cliff_t_ccz_circuit_graph(qubits: int, depth: int) -> VecGraph: ...
